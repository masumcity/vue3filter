      ...
      <div class="bg-white rounded-lg shadow-lg p-5 md:p-20 mx-2">
        <div class="text-center">
          <h2
            ...
            Computer City<span class="text-indigo-600">Apps</span>
          </h2>
          <h3 class='text-xl md:text-3xl mt-10'>Coming Soon</h3>
          <p class="text-md md:text-xl mt-10">
            All For Computer City and its Sister Company App Name And link will be here. 
          </p>
        </div>
        <div class="flex flex-wrap mt-10 justify-center">
          <div class="m-3">
            <a href="https://www.facebook.com/comcity.bd" title="Quicktoolz On Facebook"
          ...
          <div class="m-3">
            <a href="https://twitter.com/cctlbd" title="Quicktoolz On Twitter"
          ...
          <div class="m-3">
            <a href="https://www.instagram.com/comcitybd/" title="Quicktoolz On Pinterest"
          ...
          <div class="m-3">
            <a href="https://www.youtube.com/c/ComputerCityTechnologiesLtd" title="Quicktoolz On Facebook"
