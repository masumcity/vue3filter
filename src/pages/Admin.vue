<template>
  <div class="container mx-auto">
    <h1 class="text-red-600 text-2xl p-6 text-center">Website Search</h1>
            ...
            <table class="min-w-full text-left text-sm font-light">
              <thead class="border-b bg-white font-medium dark:border-neutral-500 dark:bg-neutral-600">
                <tr>
                  ...
                  <th scope="col" class="px-6 py-4"> Hosted </th>
                  <th scope="col" class="px-6 py-4"> IP </th>
                  <th scope="col" class="px-6 py-4"> URL </th>
                </tr>
              </thead>
              <tbody>
                <tr v-for="(list, index) in filtereds.sort((a, b) => (a.name > b.name) ? 1 : -1)" :key="index"
...
<script>
import sites from "../data/website.json";
export default {
  data() {
    return {
      sitelists: [],
